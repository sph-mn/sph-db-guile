...
allocations; if(!memreg_heap_new(2, &allocations)) { return(1); }
...
#define memreg_heap_new(register_size, register_address) \
  memreg_register_new(register_size, register_address)
