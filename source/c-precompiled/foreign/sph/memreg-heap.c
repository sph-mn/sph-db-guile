...
similar to memreg.c but uses a specialised heap allocated array for the memory
register that can be passed between functions usage: memreg_register_t
allocations; if(!memreg_heap_allocate(2, &allocations)) { return(1); }
