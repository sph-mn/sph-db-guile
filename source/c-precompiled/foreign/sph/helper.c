...
#define sph_helper_malloc_string(size, result) \
  sph_helper_primitive_malloc_string(size, ((uint8_t**)(result)))
#define sph_helper_calloc(size, result) \
  sph_helper_primitive_calloc(size, ((void**)(result)))
#define sph_helper_realloc(size, result) \
